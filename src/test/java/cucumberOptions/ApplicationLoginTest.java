...
@CucumberOptions(
        features = {"src/test/java/features/loginScenarioOutline.feature"}, // specify where the feature files are kept
        glue = {"stepDefinition"}, // specify where the steps definition files are kept
        plugin = {"pretty", "html:src/test/java/reports/HTMLReports/ScenarioOutlineReport1.html",
                "json:src/test/java/reports/JSONReports/ScenarioOutlineReport2.json",
